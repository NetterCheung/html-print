...
body,table,td,tr,p,span,div{
    font-family: 'Times New Roman', Times, 'PMingLiU', 'MingLiU', 'MingLiU-HKSCS', serif;
    font-size: 12px;
}

</style>
<body>
<table style="width: 639px; border-spacing: 0px; margin: 0.62cm auto 0; height: 1075px;">
...
<td style="width: 639px;">
<table cellpadding="1" cellspacing="0" style="margin-top:0.15cm;">
 <tr>
  <td>本署檔號</td>
...
<p><span>先生 / 女士：</span></p>
<p></p>
<p style="text-align: center;margin-top:0.1cm;"><span><u><b>保 留 登 記 號 碼 <c:out value="${requestScope.pageValue.regMark}"/></b></u></span></p>
<p></p>
<blockquote>
<p><span>多謝你在 
...
<p></p>
<blockquote>
<p style="margin-bottom: 12px;margin-top: -0.1cm;"><span >請注意以下各點：</span></p>
<table style="width: 585px;">
 <tr>
  <td style="width: 29px; vertical-align: top;">
  <p style="text-align: left;margin-top: -0.1cm;">(a)<br></td>
...
<p style="margin-top: 0.1cm;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如果你收到本信件前已收到本署發出的備忘錄，提醒你保留期限即將屆滿，請你毋需理
會該備忘錄。</p>
...
<tr><td style="width: 100%;padding-left: 10em;">
	<table style="border-spacing: 0px;">
		<tr><td style="width: 140px; font-size: 0; line-height: 0; height: 0;">&nbsp;</td>
			<tr><td>
		<table style="text-align: left;margin-top: -0.4cm;">
		<tr>
		<c:choose>
			...
			<td style="text-align: left;white-space: nowrap;"><c:out value="${requestScope.pageValue.applicantAddress1}"/></td>
		</tr><tr>
...
<p style="text-align: center;margin-top: -0.2cm;"><font size="-2"><c:out value="${requestScope.pageValue.officeNameChi}" /><br><c:out value="${requestScope.pageValue.officeNameEng}" /><br>
...
<tr>
	<td>
		<table style="width: 100%; border-spacing: 1px; margin: 0.60cm auto 0;">
			<tr style="text-align: left;">
          <td style="padding: 2px;"><img alt="" src="<print:BlankFormPrint imageName='logo.gif'/>" ></td>
        </tr>
		</table>
...
<table style="width: 620px;margin-top: -0.08cm;">
   <tr>
...
<p style="margin-top: -0.3cm;"><span>Dear Sir / Madam,</span></p>
<p style="text-align: center;margin-top: -0.28cm;"><span><u><b>Retention of Registration Mark <c:out value="${requestScope.pageValue.regMark}"/></b></u></span></p>
<p>
...
<tr><td style="vertical-align: top;">
	<blockquote>
<table style="width: 561px;margin-top: -0.38cm;">
 <tr>
 ...
 <tr>
  ...
  <td style="width: 522px;"><p style="margin-top: -0.08cm;">You should assign this registration mark to a vehicle registered in your name <u><b>on or before
...
<tr><td>
<p style="margin-top: -1cm;text-indent:4.7em;">
...
<tr><td>
<table style="margin-left: auto; margin-right: 0;margin-top: -0.4cm;">
<tr><td style="text-align: center;">
  <p style="text-align: center;margin-top: -0.08cm;"><span>Yours faithfully,</span></p><br><br><p>
...
<tr>
<td>
	<table style="width: 100%; border-spacing: 0px;margin-top: -0.5cm;">
