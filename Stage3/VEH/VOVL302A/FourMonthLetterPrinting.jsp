  ...
  <table class="cellpadding-0" style="border-spacing: 0px; width: 578px; margin: 0 auto">
    ...
    <tr>
      <td> <table class="cellpadding-0" style="border-spacing: 0px; width: 100%; margin-left: auto">
          <tr>
            <td style="width: 4%; height: 12px">&nbsp;</td>
            <td style="width: 33%;text-align: left;"><span class="style2">檢驗汽車機械及格證書</span></td>
            <td style="width: 51%">&nbsp;</td>
            <td style="width: 12%">&nbsp;</td>
          </tr>
          <tr>
            <td style="width: 4%; height: 12px">&nbsp;</td>
            <td style="width: 33%;text-align: left;"><span class="style2">簽發日期：</span></td>
            <td style="width: 51%"><p class="four"><B>
          ...
          <tr>
            <td style="width: 4%; height: 12px">&nbsp;</td>
            <td style="width: 33%;text-align: left;"><span class="style2">車輛登記號碼：</span></td>
            <td style="width: 51%; text-align: left;"><p class="four" style="margin: 0; padding: 0;"><B><c:out value="${fourMonthPv.regMark}"/></B></p></td>
            <td style="width: 12%">&nbsp;</td>
          </tr>
        </table></td>
    </tr>
    ...
    <tr>
      <td style="height: 16px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style2">以上檢驗汽車機械及格證書讓你可在其簽發日期後四個月內</span></td>
    </tr>
    <tr>
      <td style="height: 16px;text-align: left;"><span class="style2">申領一張為期12個月的車輛牌照。</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td style="height: 16px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style2">由於你選擇以上述證書申領有效期只有4個月的車輛牌照，</span></td>
    </tr>
    <tr>
      <td style="height: 16px;text-align: left;"><span class="style2">該證書仍可供為同一車輛申請續領有效期不超逾<U>&nbsp;
    ...
    <tr>
      <td style="height: 16px;text-align: left;"><span class="style2">的4個月車輛牌照之用；即若你能依時換領牌照以致牌照有效期沒有</span></td>
    </tr>
    <tr>
      <td style="height: 16px;text-align: left;"><span class="style2">中斷的話，你可再申領兩個各為期4個月的車輛牌照。</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td style="height: 16px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style2">請注意，若你須申請有效期超逾上述第二段所訂明的日期的</span></td>
    </tr>
    <tr>
      <td style="height: 16px;text-align: left;"><span class="style2">車輛牌照，你便須將有關車輛再次提交檢驗並獲取新的及格證書方可。</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td style="text-align: left;"><U>&nbsp;&nbsp;&nbsp;&nbsp; <fmt:formatDate value="${now}" pattern="yyyy"/>
...
<div id="page_last" style="PAGE-BREAK-AFTER: auto; text-align: center">
  <table class="cellpadding-0" style="border-spacing: 0px; width: 642px; margin: 0 auto">
    ...
    <tr>
      <td style="text-align: left">File Ref.: <c:out value="${fourMonthPv.txnNo}"/></td>
    </tr>
    <tr>
      <td style="text-align: left">Tel. No.: <c:out value="${fourMonthPv.phoneNo}"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td style="text-align: left">Dear Sir/Madam,</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td> <table class="cellpadding-0" style="border-spacing: 0px; width: 100%; margin-left: auto">
          <tr>
            <td style="width: 3%">&nbsp;</td>
            <td style="width: 43%;text-align: left">Date of Issue of </td>
            <td style="width: 37%">&nbsp;</td>
            <td style="width: 17%">&nbsp;</td>
          </tr>
          <tr>
            <td style="width: 3%">&nbsp;</td>
            <td style="width: 43%;text-align: left">Certificate of Roadworthiness/Fitness:</td>
            <td style="width: 37%"><p class="four"><B><c:out value="${strExamDate}"/></B></p></td>
            <td style="width: 17%">&nbsp;</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td> <table class="cellpadding-0" style="border-spacing: 0px; width: 100%; margin-left: auto">
          <tr>
            <td style="width: 3%">&nbsp;</td>
            <td style="width: 21%;text-align: left">Vehicle No.:</td>
    ...
    <tr>
      <td style="text-align: left">within 4 months from its date of issue for a 12-month vehicle licence.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="text-align: left">vehicle licence. Hence, the certificate is still valid to allow application
        for renewal of</td>
    </tr>
    <tr>
      <td style="text-align: left">4-month licence with expiry date not exceeding<U>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${strUptoDate}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</U>for
        the</td>
    </tr>
    <tr>
      <td style="text-align: left">same vehicle. &nbsp;In other words, if you apply for renewal of vehicle
        licence on time and</td>
    </tr>
    <tr>
      <td style="text-align: left">the licences are consecutive to each other, &nbsp;you may be issued
        with two more 4-month</td>
    </tr>
    <tr>
      <td style="text-align: left">vehicle licences.</td>
    </tr>
    <tr>
      <td style="height: 1px; font-size: 0;">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td style="text-align: left">expiry date exceeds the date specified in paragraph 2 above, you are
        required to submit</td>
    </tr>
    <tr>
      <td style="text-align: left">a fresh Certificate of Roadworthiness/Fitness, i.e. your vehicle has
        to undergo and pass</td>
    </tr>
    <tr>
      <td style="text-align: left">a vehicle examination again.</td>
    </tr>
    <tr>
      <td style="height: 1px; font-size: 0;">&nbsp;</td>
    </tr>
