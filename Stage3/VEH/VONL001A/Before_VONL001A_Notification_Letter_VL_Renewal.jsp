	...
	<tr>
		<td style="text-align: center;">
			<table style="width: 100%; border-spacing: 1px;">
				...
				<tr>
					<td style="width: 11%; padding: 2px;">Our Ref.:</td>
					<td style="padding: 2px;" colspan="2"> </td>
				</tr>
				<tr>
					<td style="padding: 2px;">Tel No.:</td>
					<td style="padding: 2px;" colspan="2"><c:out value="${issuePrintingCtlValue.telNo1}"/> </td>
				</tr>
				<tr>
					<td style="padding: 2px;">Date:</td>
					<td style="padding: 2px;" colspan="2"><%=printDateStr %> </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="padding: 2px;" colspan="2">	<%= nameAndTitleEng%></td>
				</tr>

				<tr>
					<td style="padding: 2px;">&nbsp;</td>
					<td style="padding: 2px;" colspan="2"><c:out value="${legalEntityVal.threeLineAddrEng[0]}" escapeXml="false"/></td>
				</tr>
				<tr>
					<td style="padding: 2px;">&nbsp;</td>
					<td style="padding: 2px;" colspan="2"><c:out value="${legalEntityVal.threeLineAddrEng[1]}" escapeXml="false"/></td>
				</tr>
				<tr>
					<td style="padding: 2px;">&nbsp;</td>
					<td style="padding: 2px;" colspan="2"><c:out value="${legalEntityVal.threeLineAddrEng[2]}" escapeXml="false"/></td>
				</tr>
						...
						<p style="text-indent:1cm;text-align:justify;">
							...
							<p style="text-indent:1cm;text-align:justify;">
								...
								<p style="text-indent:1cm;text-align:justify;">
									...
									<table style="width: 100%; border-spacing: 0px; text-align: right;">
										<tr>
				...
				<table style="width: 620px; border-spacing: 0px; margin: 0 auto;">
					...
					<tr>
						...
						<table style="width: 100%; border-spacing: 1px;">
							<tr style="display: none;"><th>col1</th><th>col2</th><th>col3</th></tr>
							<tr>
								<td style="width: 14%; padding: 2px;">本署檔號：</td>
								<td style="padding: 2px;" colspan="2"></td>
							</tr>
								<tr>
									<td style="padding: 2px;">電話：</td>
									<td style="padding: 2px;" colspan="2"><c:out value="${issuePrintingCtlValue.telNo1}"/></td>
								</tr>
								<tr>
									<td style="padding: 2px;">日期：</td>
									<td style="padding: 2px;" colspan="2"><%=printDateYear %>年<%=printDateMonth %>月<%=printDateDay %>日</td>
								</tr>
								<tr>
									<td style="padding: 2px;" colspan="3">&nbsp;</td>
								</tr>
								<tr>
									<td style="padding: 2px;"> 致：</td>
									<td style="padding: 2px;" colspan="2">	<%= nameAndTitleChi%></td>
								</tr>
								<tr>
									<td style="padding: 2px;">&nbsp;</td>
									<td style="padding: 2px;" colspan="2"><c:out value="${legalEntityVal.threeLineAddrChi[0]}" escapeXml="false"/></td>
								</tr>
								<tr>
									<td style="padding: 2px;">&nbsp;</td>
									<td style="padding: 2px;" colspan="2"><c:out value="${legalEntityVal.threeLineAddrChi[1]}" escapeXml="false"/></td>
								</tr>
								<tr>
									<td style="padding: 2px;">&nbsp;</td>
									<td style="padding: 2px;" colspan="2"><c:out value="${legalEntityVal.threeLineAddrChi[2]}" escapeXml="false"/></td>
								</tr>
								<tr>
									<td style="padding: 2px;" colspan="3">&nbsp;</td>
								</tr>
								...
								<tr>
									...
									<td style="padding: 2px; vertical-align: top;" colspan="2">
										...
										<p style="text-align:center;">
											<div style="text-align:center;text-decoration:underline;font-weight:bold;">續領車輛牌照</div>
											<div style="text-align:center;">(車輛登記號碼編號：<%=regMark %>)</div>
										</p>
