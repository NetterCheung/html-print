...
<table style="width: 620px; border-spacing: 0px; margin: 0 auto;">
	...
	<table>
		...
		<tr style="transform: translateY(-0.2em);">
		<td>Tel.: </td>
		<td>2804 2642 </td>
		</tr>
		<tr>
	...
	<p></p>
	<p style="text-align: right;margin-top: -0.4em;"><jsp:useBean id="now" class="hk.gov.valid.util.ValidIVDate" />
	<fmt:formatDate value="${now}" pattern="d MMMMMMMMMM yyyy"/></p>
	<p style="margin-top: -0.2em;"><span>Dear Sir / Madam,</span></p>
	<p style="text-align: center;margin-top: 0.1cm;"><span><u><span class="win10_bold">Reservation of Registration Mark(s) for Auction</span></u></span></p>
	...
	<table style="margin-left: auto; text-align: right; width: auto;margin-top: -4.5em;">
	<tr><td style="text-align: right;">
	<p style="text-align: right; margin: 0;"><span>Yours faithfully,</span><br><br><br><br>
...
<table style="width: 624px; border-spacing: 0px; margin: 0 auto;" lang=ZH-TW>
	...
	<tr><td  class="style1">
		<p></p>
		<p style="margin-top: -1.2em;">先生 / 女士：<br><br></p>
		<p></p>
		<p style="text-align: center;margin-top: 0.1cm;"><span class="win10_bold"><u>預留車輛登記號碼以作拍賣</u></span></p>
		<p style="text-align: justify;margin-top: 0.1cm;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<!-- Begin Reserved Reg Mark List -->
			...
			<table style="width: 100%; border-spacing: 0px;">
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td style="width: 100%;">
				<table style="width: 100%; border-spacing: 1px;margin-top: -0.05em">
					<tr>
					<c:set var="count" value="0"/>
					<c:set var="rowcount" value="0"/>
					<c:forEach var="regmark" items="${approvedNSRMs}">
		...
		<p style="text-align: justify;margin-top: 0.5cm;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<blockquote style="margin-top: 0.45cm;">
		&nbsp;申請被接納後，不得撤回。
		</blockquote>
		<P style="text-align: justify;margin-top: 0.38cm;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr><td style="width: 639px;">
	<table style="margin-left: auto;margin-top: -1.5em">
		<tr><td  class="style1">
			<p style="text-align: center;">運輸署署長</p>
			<p style="text-align: center;margin-top: -0.1cm;"><br><br><br>
	...
	<tr style="transform: translateY(-0.3cm);"><td><span class="style1">
