...
<table style="margin: 0 auto; width: 670px; height: 100%;">
 ...
 <td style="text-align: center;">
  <table class=MsoTableGrid style='border-collapse:collapse; border-spacing: 0px; width: 100%; margin: 0 auto;'>
   ...
   <tr>
			...
			<!--<img width=260 height=69 src="<print:BlankFormPrint imageName='TD_Logo.gif'/>"/>-->
			 ...
			 <td colspan=5 style='vertical-align: top; text-align: left; width:50%;padding:0cm;height:0'>
  ...
  <tr>
          <td colspan=14 style='vertical-align: top; padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm'>
            <p class=MsoNormal style='text-align:left'><span lang=EN-US style='font-family:Arial;font-size:9pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span lang=ZH-TW style='font-size:9pt;font-family:MingLiU_HKSCS;letter-spacing:0pt'>本署曾郵寄下列的強制性修習駕駛改進課程通知書給你，但獲香港郵政退回。根據記錄，你尚未完成修習和完成有關課程。現隨函夾附有關的通知書給你：</span>
            </p></td>
	  <td colspan="3" style="display: none;"></td>
	</tr>
	<tr>
