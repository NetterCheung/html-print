...
<c:set var="nondeliveredMdicNoticeAndReminderValue" value="${requestScope.nondeliveredMdicNoticeAndReminderValue}" scope="request" />
<c:set var="LEGAL_ENTITY_VALUE" value="${nondeliveredMdicNoticeAndReminderValue.legalEntityValue}" scope="request"/>
<c:set var="MDIC_NOTICE_REPORT_VALUE_COLLECTION" value="${nondeliveredMdicNoticeAndReminderValue.mdicNoticeReportValueCollection}" scope="request"/>
<c:set var="MDIC_COVER_NOTE_VALUE" value="${nondeliveredMdicNoticeAndReminderValue.mdicCoverNoteValue}" scope="request"/>
...
<div class="firstpage">
	<jsp:include page="Print_MDIC_AOMD022A.jsp" />
</div>
...
<c:forEach var="MDIC_NOTICE_REPORT_VALUE" items="${MDIC_NOTICE_REPORT_VALUE_COLLECTION}" >
	<c:set var="MDIC_NOTICE_VALUE" value="${MDIC_NOTICE_REPORT_VALUE.mdicNoticeValue}" scope="request"/>
	<c:set var="ISSUE_PRINTING_CTL_VALUE" value="${MDIC_NOTICE_REPORT_VALUE.noticeIssuePrintingCtlValue}" scope="request"/>
	<c:set var="MDIC_COVER_NOTICE_VALUE" value="${nondeliveredMdicNoticeAndReminderValue.mdicCoverNoteValue}" scope="request" />
	<c:set var="MDIC_NOTICE_TICKET_MAP_VALUE_COLLECTION" value="${MDIC_NOTICE_REPORT_VALUE.mdicNoticeTicketMapCollection}" scope="request" />
	<div class="page" >
