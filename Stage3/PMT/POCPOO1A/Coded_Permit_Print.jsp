		...
		layout-grid-mode:char'><span lang=EN-US style='font-size:8.0pt'>&nbsp;</span></p></td>
				...
				<tr> 
					...
					<table  style='border-collapse:collapse;width: 360px;'>
						...
						<tr>
							<td style="width: 50%;">
								<p style="text-align: left;margin-top: 0.2cm;">
		...
		layout-grid-mode:char'><span lang=EN-US style='font-size:7.0pt'>&nbsp;</span></p></td>
		 ...
		 style='border-collapse:collapse;width: 360px;'>
		  ...
		  lang=EN-US style='font-size:9.0pt'>No. &nbsp;</span><strong><span lang=EN-US style='font-size:9.0pt;mso-bidi-font-size:11.0pt;font-family:Times New Roman'><c:out value="${PermitPrintValue.permitNo}" />&nbsp;&nbsp;&nbsp;&nbsp;</span></strong></td>
					...
					<td style="padding-left:10pt;text-align: center;vertical-align: top;">
		...
		<c:set var="count" value="${count + 1}" />	
		 <tr style="transform: translateY(2em);">
			 <td style='vertical-align: top; text-align: left; width: 15pt; padding: 0 2pt 0 0;'>
				 <p style='margin:0; line-height:1.2;'><span lang=EN-US style='font-size:8.0pt; font-family:Times New Roman;'><c:out value="${count}" />.</span></p>
		     </td>
			 <td style='vertical-align: top; text-align: left; padding: 0;'>
			  <p style='margin:0; line-height:1.2;'><span lang=ZH-TW style='font-size:8.0pt; font-family:MingLiU;'><c:out value="${optMandatoryCondValue.interpretationChi}" /></span></p>
				 <p style='margin:0; line-height:1.2;'><span lang=EN-US style='font-size:8.0pt; font-family:Times New Roman;'><c:out value="${optMandatoryCondValue.interpretationEng}" /></span></p>
		      </td>
		 </tr>
...
<c:forEach var="PermitPrintValue" items="${PermitPrintValues}">
						...
						<table class=MsoTableGrid
						 style='border-collapse:collapse;width: 360px;'>
						    <tr> 
						      ...
						      <td rowspan="2" style='height: 32px;vertical-align: top;padding-left:2pt;padding-top:0cm; padding-bottom:0cm;text-align: left'><span style='font-size:10.0pt;letter-spacing:1.0pt;color:black;word-break:normal;word-wrap:normal'><span class="win10_bold">
								     <c:if test="${PermitPrintValue.ownerNameChi != null}">
									     <c:out value="${PermitPrintValue.ownerNameChi}"/><br>
								     </c:if>
								     <c:out value="${PermitPrintValue.ownerNameEng}"/>
		...
		<td colspan="2" style="width: 350px;">
			...
			<table class=MsoNormalTable
				style='border-collapse: collapse;width: 100%;'>
				<tr>
					<td style='vertical-align: top;width: 13%;padding:0cm 1pt 0cm 1pt'><span lang=EN-US style='font-size:7pt;text-align: left'>Registration Mark </span></td>
	                <td style='vertical-align: top;text-align: left;width: 13%;padding:0cm 1pt 0cm 1pt' nowrap><b><span lang=EN-US style='font-size:7pt;color:black'>&nbsp;
	                  <c:out value="${PermitPrintValue.regMark}"/>
	                </span></b></td>
	                <td style='vertical-align: top;width: 10%;padding:0cm 1pt 0cm 1pt'><span lang=EN-US style='font-size:7pt;text-align: left'>Date of issue</span></td>
	                <td style='vertical-align: top;width: 15%;padding:0cm 1pt 0cm 1pt'><b><span lang=EN-US style='font-size:7pt;color:black'>
	                  <fmt:formatDate value="${PermitPrintValue.issueDate}" pattern="dd/MM/yyyy" />
	                </span></b></td>
	                <td style='vertical-align: top;width: 15%;padding:0cm 1pt 0cm 1pt'><span lang=EN-US style='font-size:7pt'>Transaction</span></td>
		...
		<c:set var="count" value="${count + 1}" />	
		 <tr style="transform: translateY(2em);" >
		  ...
		  <td style='vertical-align: top; text-align: left; padding: 0;'>
			  <p style='margin:0; line-height:1.2;'><span lang=ZH-TW style='font-size:8.0pt; font-family:MingLiU;'><c:out value="${optMandatoryCondValue.interpretationChi}" /></span></p>
			  <p style='margin:0; line-height:1.2;'><span lang=ZH-TW style='font-size:8.0pt; font-family:MingLiU;'><c:out value="${optMandatoryCondValue.interpretationEng}" /></span></p>
		  </td>
		 </tr>
		 <tr><td colspan="2">&nbsp;</td></tr> 
		</c:forEach>
