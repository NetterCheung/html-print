...
<body>
  ...
  <table style="TABLE-LAYOUT: fixed; width: 600px; height: 680px; margin: 0 auto; border-spacing: 0px">
  <tr>
  ...
  <tr>
	<td style="vertical-align: top">
		<p><span class="STYLE2">致</span>&nbsp;/&nbsp;<span class="STYLE1">To</span><span class="STYLE2">&nbsp;:&nbsp;</span><c:if test="${IS_COMPANY == false}">
  ...
  <tr>
	<td style="height: 130px; vertical-align: top">
		<p style="text-align: justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE2">多謝你通知本署你現時的地址。現時你於本署的最新地址記錄載列如下，以供參考。如有任何查詢，請與本署聯絡或致電1823。</span></p>
		<p style="text-align: justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE1">Thank you for your notification of your present address.&nbsp;Your updated address record in this Department is appended below for your reference.&nbsp;Should you have any enquiries, please contact this Department or 1823.</span></p>
	</td>
  </tr>
