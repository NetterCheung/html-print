...
<html>
<head>
<title>Dishonoured Cheque - Cancel Settle Payment Log</title>
<meta charset="UTF-8">
...
<table style="width: 100%; border-spacing: 0px; margin: 0 auto;">
  ...
  <tr>
    <td style="width: 10%; white-space: nowrap; vertical-align: top;">REPORT ID : MODC010A</td>
  ...
  <tr>
    ...
    <td style="width: 80%;">
      <div style="text-align: center;">DISHONOURED CHEQUE - CANCELLATION OF SETTLE PAYMENT LOG</div>
    </td>
...
<table style="width: 100%; border-spacing: 0px; margin: 0 auto;">
  ...
  <tr>
    ...
    <td style="width: 25%; vertical-align: top;"><c:out value="${dcRecBusinessValueNow.settlementTxnNo}"/></td>
  </tr>
  <tr>
    ...
    <td style="width: 25%; vertical-align: top;"><fmt:formatDate value="${dcContactManValue.dcTenderDate}" pattern="dd/MM/yyyy HH:mm:ss"/></td>
  </tr>
</table>
<br>
...
<table style="width: 100%; border-spacing: 0px; margin: 0 auto;">
  ...
  <tr>
    ...
    <td style="width: 25%; vertical-align: top;">Transaction type</td>
    <td style="width: 20%; vertical-align: top;">Application Ref</td>
    <td style="width: 25%; vertical-align: top;">Fee type</td>
    <td style="width: 20%; text-align: right; vertical-align: top;">Amount</td>
  </tr>
