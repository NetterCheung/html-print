...
<table style="margin:0 auto;height:98%;width:720px">
 ...
 <td  style="text-align:-webkit-center;border:0">
    ...
    <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
      <p class=MsoNormal style='text-align:right;'><span lang=EN-US style='font-family:Arial;font-size:10pt'><span style='color:black'>
	  	<c:choose>
			...
			<c:otherwise>
				<c:out value="${OTSIC_NOTICE_VALUE.idType}"/>&nbsp;&nbsp;
				<SCRIPT >
				    var idNo = "<c:out value="${OTSIC_NOTICE_VALUE.idNo}"/>";
				    document.write(getMaskedIdNo(idNo));
				</SCRIPT>
  ...
  <tr style="transform: translateY(-0.2cm)">
   ...
   <tr style="transform: translateY(-0.5cm)">
    <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
	  <p class=MsoNormal style='text-align:center;layout-grid-mode:char;'>
		<span lang=ZH-TW style='font-size:10pt;font-family:MingLiU_HKSCS;letter-spacing:0pt'><span class="win10_bold">強制性修習的士服務改進課程通知書</span></span>
	  </p>
	  <p class=MsoNormal style='text-align:center;layout-grid-mode:char;'>
	  ...
	  <p class=MsoNormal style='text-align:justify;text-justify:inter-character;layout-grid-mode:char;line-height:7pt;margin-top: -0.15cm;'><span lang=EN-US style='font-family:Arial;font-size:1pt;line-height:7pt'>&nbsp;</span>
	        <p class=MsoNormal style='text-align:center;layout-grid-mode:char;'> 
              <span lang=ZH-TW style='font-size:10pt;font-family:MingLiU_HKSCS;letter-spacing:0pt'><span class="win10_bold">《的士司機違例記分條例》(第647章)</span></span>
            </p>
	  <p class=MsoNormal style='text-align:center;layout-grid-mode:char;'>
   ...
   <tr style="transform: translateY(-0.57cm)">
     <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
       <p class=MsoNormal style='text-align:left;'><span lang=EN-US style='font-family:Arial;font-size:9pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
	   ...
	   <p class=MsoNormal style='text-align:justify;text-justify:inter-character;layout-grid-mode:char;margin: 0;padding: 0;line-height: 1.0;margin-top: -0.05cm;'><span lang=EN-US style='font-family:Arial;font-size:9pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
   ...
   <tr>
	<td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
	  <table style="border-collapse: collapse;border-spacing:0;margin-top: -0.68cm;">
	    <tr>
		  ...
		  <table style="border-collapse: collapse;border-spacing:0;border: none; border-bottom: 1px solid black;width:100%"><tr style="display:none"><th>Col1</th><th>Col2</th><th>Col3</th><th>Col4</th><th>Col5</th><th>Col6</th><th>Col7</th><th>Col8</th><th>Col9</th><th>Col10</th><th>Col11</th><th>Col12</th><th>Col13</th><th>Col14</th></tr>
		  <tr>
   ...
   <tr style="transform: translateY(-0.42cm);">
    <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
      <p class=MsoNormal style='text-align:left;line-height: 1.1;padding: 0;margin: 0'><span lang=EN-US style='font-family:Arial;font-size:9pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
	   ...
	   <p class=MsoNormal style='text-align:justify;text-justify:inter-character;layout-grid-mode:char;line-height: 1.1;padding: 0;margin: 0;margin-top: 0.1cm;'><span lang=EN-US style='font-family:Arial;font-size:9pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
   ...
   <tr>
    <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;height:50%;border:0;padding:0px'>
     ...
     <tr>
     <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'> 
       <p class=MsoNormal style='text-align:left;text-align:left'><span lang=EN-US style='font-family:Arial;font-size:9pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
     ...
     <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
        <p class=MsoNormal style='text-align:left;word-break:break-all;line-height:9pt;'>
			...
			<c:if test="${!empty workStationID}">
	   			<c:out value="${workStationID}"/>,<c:out value="${operatorID}"/>,<fmt:formatDate value="${OTSIC_NOTICE_VALUE.printDate}" pattern="dd/MM/yyyy HH:mm:ss" />
			</c:if>
		&nbsp;</span>
	   </p>
     </td>
