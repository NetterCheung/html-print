...
<table style="border-spacing:0;width:100%">
  <tr style="display:none"><th>Col1</th><th>Col2</th></tr>
	...
	<tr>
		<td style="font-size:12pt;font-family:Times New Roman;text-align:-webkit-center;padding:0px;border:0;margin-top: -0.1cm;"><u>Driving Test Appointment Letter</u></td>
...
<table style="border-spacing:0;width:100%;margin-top: -0.9cm;">
   	<tr>
...
<table class="A4" style="border-spacing:0;width:100%;margin-top: 0.25cm;">
<tr><td style="height:2px;padding:0px;border:0"></td></tr>
  <tr>
    <td style="padding:0px;border:0">
      ...
      <hr class="hline" style="margin:0.2em auto;border:0; border-top:1px solid #000">
      ...
      <table class="collapse_border_table" style="border-spacing:0;width:100%">
        <tr>
          <td class="collapse_border_table" style="text-align:-webkit-center;height:37px;width:20%;padding:3px;">Test Date<br>(Day/Month/Year)</TD>
        ...
        <tr>
          <td class="collapse_border_table" style="text-align:-webkit-center;height:37px;padding:3px;">Test Time</TD>
          <td class="collapse_border_table" style="text-align:-webkit-center;padding:3px;"><c:out value="${appointValue.testTime}"/></TD>
        </tr>
        <tr>
          <td class="collapse_border_table" style="text-align:-webkit-center;height:45px;padding:3px;"><span style="white-space:nowrap">Test Form No.</span><span style="white-space:nowrap">(Test Form Issue Date)</span></TD>
      ...
      <table style="border-spacing:0;width:100%">
        <tr>
          <td class="list_content" style="padding:3px;border:0;margin-top: -0.3cm;">
            <p style="margin-top: 0cm;">You are advised to report your arrival to the Test Centre 15 minutes before test, bringing with you the following
        ...
        Candidate will not be tested if items (2), (5), (7) above is defaced.
			...
			<c:if test="${appointValue.testType != '1' && !((appointValue.testType == '2') && (appointValue.deCode == 6))}">
				<c:if test="${ !(appointValue.deCode == 3 || appointValue.deCode == 22) }">
				<p style="margin-top: 0.6cm;">Candidates should remind the driving instructor who accompanies them to attend driving test (if any) to provide the Driving Examiner conducting the test with his / her private driving instructor’s licence (only applicable to candidates receiving driving training from private driving instructors).</p>
				</c:if>
			<p style="margin-top: 0.6cm;">Candidate will also not be tested if the vehicle presented is not of the class applied for.</p>
        <c:choose>
        <c:when test="${ !(appointValue.deCode == 3 || appointValue.deCode == 22) }">
        <p style="margin-top: 0.4cm;">If the validity date of the Vehicle Licensing Notice mentioned in item (6) is not yet come into effect on the day of the driving test, the old vehicle license plate with expiry date of the test vehicle must be presented so as to ensure that the vehicle licence is still valid on the day of the driving test.</p>
        </c:when>
        <c:otherwise>
        <p style="margin-top: 0.4cm;">If the validity date of the Vehicle Licensing Notice mentioned in item (7) is not yet come into effect on the day of the driving test, the old vehicle license plate with expiry date of the test vehicle must be presented so as to ensure that the vehicle licence is still valid on the day of the driving test.</p>
        </c:otherwise>
        </c:choose>
			</c:if>
            <p style="margin-top: 0.4cm;">Candidate who fails to produce any one or all of the above documents may NOT be allowed to take the test and his / her test form may be invalidated.  If he / she wants to take the driving test again, he / she will have to purchase a new test form.</p>
            <p style="margin-top: 0.6cm;">Before candidates are allowed to proceed with the road test, they are required to read at a distance of approximately 23 metres, with the aid of corrective lenses if worn, a motor vehicle registration number.  Candidates who fail the vision test may NOT be allowed to take the road test and their test form may be invalidated.  If they want to take the driving test again, they will have to purchase a new test form.</p>
          </td>
        </tr>
      </table>
      
      <table class="collapse_border_table" style="border-spacing:0;width:100%;margin-top: -0.4cm;"><tr style="display:none"><th>Col1</th><th>Col2</th><th>Col3</th></tr>
        <tr>
      ...
      <table style="border-spacing:0;width:100%;margin-top: -0.3cm;"><tr style="display:none"><th>Col1</th><th>Col2</th><th>Col3</th></tr>
        <tr>
