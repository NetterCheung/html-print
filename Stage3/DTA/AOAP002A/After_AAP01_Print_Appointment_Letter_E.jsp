...
<table class="A4" style="border-spacing:0;width:100%;margin-top: 0.4cm;">
<tr><td style="height:5px;padding:0px;border:0"></td></tr>
  <tr>
    <td style="padding:0px;border:0">
      ...
      <table style="border-spacing:0;width:100%;margin-top: -0.35cm;">
        <tr>
          ...
          <td style="width:20%;padding:5px;border:0">
           <table >
			    ...
			    <tr>
		          <td style="height:5px;padding:5px;border:0">&nbsp;</td>
		        </tr>
	            <tr style="margin-top: -0.4cm;">
        ...
        <tr>
         ...
         --%>
         <%--modified by Justin wong for CR-2020-012 end --%>
      </table>
      ...
      <table style="border-spacing:0;width:100%">
        <tr>
          <td class="list_content" style="padding:3px;border:0;">
             <p style="margin-top: 0.3cm;">You are advised to report your arrival to the Test Centre 15 minutes before test, bringing with you the following
        ...
        <p>If the validity date of the Vehicle Licensing Notice mentioned in item (7) is not yet come into effect on the day of the driving test, the old vehicle license plate with expiry date of the test vehicle must be presented so as to ensure that the vehicle licence is still valid on the day of the driving test.</p>
            ...
            <p style="margin-top: 0.5cm;">Candidate who fails to produce any one or all of the above documents may NOT be allowed to take the test and his / her test form may be invalidated.  If he / she wants to take the driving test again, he / she will have to purchase a new test form.</p>
            <p style="margin-top: 0.5cm;">Before candidates are allowed to proceed with the road test, they are required to read at a distance of approximately 23 metres, with the aid of corrective lenses if worn, a motor vehicle registration number.  Candidates who fail the vision test may NOT be allowed to take the road test and their test form may be invalidated.  If they want to take the driving test again, they will have to purchase a new test form.</p>
          </td>
        </tr>
      </table>
      
      <table class="collapse_border_table" style="border-spacing:0;width:100%;margin-top: -0.30cm;"><tr style="display:none"><th>Col1</th><th>Col2</th><th>Col3</th></tr>
        <tr>
      ...
      <table style="border-spacing:0;width:100%;margin-top: -0.3cm;">
	...
	<table  style="border-spacing:0;width:100%;margin-top: 0.18cm;">
	<tr>
		<%if (SessionConstant.IE9.equals((String)session.getAttribute(SessionConstant.IE_VERSION))) {%>
		...
		<tr>
          <td style="FONT-SIZE: 7pt; border:1px solid black;text-align:justify;padding:3px"><b><u>Note: </u></b>If you wish to learn to drive a motor vehicle on a road, you should be the holder of a learner's driving licence for that class of vehicles. A holder of a learner's driving licence must comply with the relevant conditions imposed under the learner's driving licence and the legal requirements. In accordance with Section 42 of the Road Traffic Ordinance (Cap. 374), no person shall drive a motor vehicle on a road unless he / she is the holder of a driving licence in respect of a vehicle of the class of vehicle which he / she is driving. Any person who contravenes this section commits an offence and is liable, in the case of a first conviction to a fine of $5,000 and to imprisonment for 3 months, and in the case of a second or subsequent conviction to a fine of $10,000 and to imprisonment for 6 months. </td>
		   </tr>
      </table>
...
<%-- Fix Issue date position --%>
      ...
      <table style="FONT-SIZE: 7pt;border-spacing:0;width:100%;">
        <tr>
          ...
          <td style="text-align:-webkit-right;padding:0px 1ch 0px 0px;border:0">TF ISSUE DATE: <c:out value="${IssueDate}"/></td>
        </tr>
