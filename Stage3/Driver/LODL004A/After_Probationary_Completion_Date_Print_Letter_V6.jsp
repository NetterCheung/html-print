            ...
            <table style="width:100%; border:0; border-spacing:1px; margin-left:auto; margin-right:auto;">
                <tr>
                    <td><p>&nbsp;</p>
                        ...
                        <table style="width:100%; border:0; border-spacing:0">
                            <tr>
                                <td style="vertical-align:top"><p style="line-height: 1px;">File Ref.: <c:out
                                        value="${requestScope.printLogTxnNo}"/></p></td>
                            </tr>
                            <tr>
                                <td style="vertical-align:top"><p style="text-align:right;line-height: 1px;">
                                    <fmt:formatDate
                                            value="${ppcdPageValue.currentDate}" pattern="dd/MM/yyyy"/></p></td>
                            </tr>
                        </table>

                        <p style="text-align:left;line-height: 1px;">Dear <codetable:out
                        ...
                        <p style="text-align:center"><span class="ENGLISH_FORMAT1"><BR><u>Date of Completion of Probationary Driving Period</u></span><br>
	  		  ...
	  		  <c:out value="${legalEntityValue.idType}"/>
                        ...
                        <p style="text-align:justify;" class="ENGLISH_FORMAT2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;According
                            to our record, the probationary driving period of the respective vehicle class(es) <br>is/are
                            as
                            follows –</p>

                        <table style="height: 61px; width: 650px;" border="1" cellspacing="0" cellpadding="0">
                            <tbody>
                            <tr style="height: 13px;">
                                <td style="width: 120px; height: 13px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Class(es)</td>
                                <td style="width: 250px; height: 13px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Start
                                    Date
                                </td>
                                <td style="width: 250px; height: 13px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date
                                    of Completion of<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Probationary
                                    Driving Period
                                </td>
                            </tr>
                            <c:forEach var="entitlementValue" items="${entitlementValues}">
                                <tr style="height: 13px;">
                                    ...
                                    <td style="width: 250px; height: 13px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <fmt:formatDate value="${entitlementValue.startDate}" pattern="dd/MM/yyyy"/>
                                    </td>
                                    <td style="width: 250px; height: 13px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <fmt:formatDate value="${entitlementValue.ppcd}" pattern="dd/MM/yyyy"/>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        ...
                        <table style="width:100%; border:0; border-spacing:0;">
                            ...
                            <tr>
                                ...
                                <td style="width:40%; vertical-align:top">
                                    <p style="text-align:center" class="ENGLISH_FORMAT2">
                                        (                                       )<br>
        ...
        <td>
            <table style="width:100%; border:0; border-spacing:1px; margin-left:auto; margin-right:auto;">
                <tr>
                    <td style="padding:2px"><p>&nbsp;</p>
                        ...
                        <table style="width:100%; border:0; border-spacing:0; margin-left:auto; margin-right:auto;">
                            <tr style="font-family: 'Times New Roman', 'MingLiU_HKSCS'">
                                <td style="vertical-align:top; padding: 2px"><p
                                        class="CHINESE_FORMAT2;line-height: 0px;">
                                    本署檔號：
                        ...
                        <p class="CHINESE_FORMAT2">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <span style="font-family:MingLiU_HKSCS;line-height: 0px;"><c:out
                        ...
                        <p style="text-align:center" class="CHINESE_FORMAT1"><u>暫准駕駛期完成日</u><br>
	  		  ...
	  		  <c:out value="${legalEntityValue.idType}"/>
                        ...
                        <table style="height: 61px; width: 650px;" border="1" cellspacing="0" cellpadding="0">
                            <tbody>
                            <tr style="height: 13px;font-family: 'Times New Roman', 'MingLiU_HKSCS'">
                                <td style="width: 120px; height: 13px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;車類類別</td>
                                <td style="width: 250px; height: 13px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;開始日期</td>
                                <td style="width: 250px; height: 13px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;暫准駕駛期完成日</td>
                            </tr>
                            <c:forEach var="entitlementValue" items="${entitlementValues}">
                                <tr style="height: 13px;">
                                    <td style="width: 120px; height: 13px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <table style="width:100%; border:0; border-spacing:0">
                            <tr>
                                <td style="width:100%; vertical-align:top; padding: 1.1px">
                                    <p style="text-align:justify;line-height: 1.1;" class="CHINESE_FORMAT2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;你現時的暫准駕駛執照有效期至<fmt:formatDate
                                    ...
                                    <p style="text-align:justify;line-height: 1.1;" class="CHINESE_FORMAT2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;你可在完成有關車輛類別的暫准駕駛期後三年內申領該車輛類別的正式駕駛執照；否則，你須重新申請及通過有關車輛類別駕駛考試，並在再完成暫准駕駛期後，才能申請該車輛類別的正式駕駛執照。</p>
                                    <p style="text-align:justify;line-height: 1.1;" class="CHINESE_FORMAT2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;以上資料是根據本署電腦系統內現時資料提供，並只更新至本函件發出的前一天，因此只供參考之用。如你的駕駛執照記錄其後有任何改變，包括駕駛執照被取消、駕駛執照過期及觸犯香港法例第374B章《道路交通（駕駛執照）規例》附表12或香港法例第375章《道路交通（違例駕駛記分）條例》內所述的罪行而被定罪，上述相關資料需作出相應更改。</p>
                                </td>
                            </tr>
                        </table>
