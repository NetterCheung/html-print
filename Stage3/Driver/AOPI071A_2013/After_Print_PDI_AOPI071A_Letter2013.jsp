...
.STYLE1 {
	font-family: "Times New Roman","MingLiU_HKSCS";
	font-size: 12pt;
	text-align: left;
	vertical-align: top;
}
  ...
  <table class="MsoTableGrid cellpadding-0" style='border-collapse:collapse;margin:0 auto;border-spacing:0'><tr style="display:none"><th>Col1</th><th>Col2</th><th>Col3</th><th>Col4</th><th>Col5</th><th>Col6</th><th>Col7</th><th>Col8</th><th>Col9</th><th>Col10</th><th>Col11</th><th>Col12</th><th>Col13</th><th>Col14</th></tr>
    <tr>
        ...
        <td style="vertical-align:bottom;width:20%;border:0;padding:0px">
				...
				<td style="text-align:right;vertical-align:bottom;width:30%;border:0;padding:0px">  
					<p class=MsoNormal style='text-align:justify;text-justify:inter-character;layout-grid-mode:char;line-height:5pt'>
	   				...
	   				<table style="border-spacing:0;width:150px"><tr><td style="border:1px solid;padding:0px"> 	
								<p class=MsoNormal style='text-align:justify;text-justify:inter-character;layout-grid-mode:char;line-height:5pt'>
	   						<span lang=EN-US style='font-family:Arial;font-size:1pt;line-height:25px'>&nbsp;</span></p>
					   <p  style="text-align:center">
							<span lang=EN-US style='font-family:Arial;font-size:30pt'>G<c:out value="${pdiGroup}"/></span>
					   </p>
			...
			<tr>
			<td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
			   <p class=MsoNormal style='text-align:justify;text-justify:inter-character;layout-grid-mode:char;line-height:0pt'>
			   <span lang=EN-US style='font-family:Arial;font-size:1pt;line-height:5pt'>&nbsp;</span></p>	
			</td>
		   </tr>
			<tr>
		   ...
		   <span lang=EN-US style='font-family:Arial;font-size:1pt;line-height:5pt'>&nbsp;</span></p>
				...
				<p style='line-height:12pt;text-align:right;padding-right:15px'><span class="STYLE2" >申請編號</span></p>
				</td>
				<td style="text-align:right;vertical-align:middle;width:30%;border:0;padding:0px;">
				   <table style="border-spacing:0;width:150px"><tr><td style="text-align:right;border:1px solid;padding:0px">
				   		<p  style="text-align:center"><span class="STYLE8"><b><c:out value="${pdiPrintValue.pdiApplNo}"/></b></span> 
            	</p>
            </td></tr></table>
				</td>
				<td style="display: none;" colspan="11"></td>
			...
			<tr>
				<td colspan="3" style="width:100%;border:0;padding:0px"><table style="width:100%">
					<tr>
						...
						<td style="width:80%;border:0;padding:0px"><p style="text-align:justify"><span class="STYLE2"><!-- in L/M &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  to -->TD DT 47/90/21/<!-- Ⅱ --><c:if test="${pdiGroup=='1'}">19</c:if><c:if test="${pdiGroup=='2'}">8</c:if><c:if test="${pdiGroup=='3'}">9</c:if> (<c:out value="${PDIAppointmentPageValue.txnNo}"/>)</span></p></td>
						<%--<td width="40%"><p align="justify"><span class="STYLE2"></span></p></td>--%>
					</tr>
					<%--<tr>
						<td width="20%"><p align="justify"><span class="STYLE2">電　　話 :</span></p></td>
						<td width="40%"><p align="justify"><span class="STYLE2">&nbsp;<c:out value="${issuePrintingCtlValue.telNo1}"/><c:if test="${!empty issuePrintingCtlValue.telNo2}">&nbsp;/&nbsp;<c:out value="${issuePrintingCtlValue.telNo2}"/></c:if><c:if test="${!empty issuePrintingCtlValue.telNo3}">&nbsp;/&nbsp;<c:out value="${issuePrintingCtlValue.telNo3}"/></c:if></span></p></td>
						<td width="40%"><p align="justify"><span class="STYLE2"></span></p></td>
					</tr>
					<tr>
						<td width="20%"><p align="justify"><span class="STYLE2">傳　　真:</span></p></td>
						<td width="40%"><p align="justify"><span class="STYLE2">&nbsp;<c:out value="${issuePrintingCtlValue.faxNo1}"/><c:if test="${!empty issuePrintingCtlValue.faxNo2}">&nbsp;/&nbsp;<c:out value="${issuePrintingCtlValue.faxNo2}"/></c:if><c:if test="${!empty issuePrintingCtlValue.faxNo3}">&nbsp;/&nbsp;<c:out value="${issuePrintingCtlValue.faxNo3}"/></c:if></span></p></td>
						<td width="40%"><p align="justify"><span class="STYLE2"></span></p></td>
					</tr>--%>
				</table></td>
				<td style="display: none;" colspan="11"></td>
   ...
   <tr>
    <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
	  <p style="text-align:center">
		<span class="STYLE2"><u><b>第<c:if test="${pdiGroup=='1'}"><span class="STYLE2">一</span></c:if><c:if test="${pdiGroup=='2'}"><span class="STYLE2">二</span></c:if><c:if test="${pdiGroup=='3'}"><span class="STYLE2">三</span></c:if>組別私人駕駛教師考試 - <c:if test="${PDIAppointmentPageValue.testType == '6'}">路試</c:if><c:if test="${PDIAppointmentPageValue.testType == '5'}">電腦化筆試</c:if></b></u></span>
	  </p>
   </td>
  </tr> 
   <tr>
   ...
   <tr>
     <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
       <p style="text-indent: 2em; text-align: justify;">
	   		<span class="STYLE2">就你申請上述私人駕駛教師考試，本署現安排有關<c:if test="${PDIAppointmentPageValue.testType == '6'}">路試</c:if><c:if test="${PDIAppointmentPageValue.testType == '5'}">筆試</c:if>，詳情如下：</span>
	   </p>
     </td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td class="STYLE2" style="border:0;padding:0px;text-align:left;">
   ...
   <tr>
     ...
     <td  class="STYLE2" style="vertical-align: top;border:0;padding:0px;text-align:left;">
   ...
   <tr>
     <td colspan=14  style="vertical-align:top;border:0;padding:0px">
       <p style="text-indent: 2em; text-align: justify; text-justify:inter-character;"><span class="STYLE2">上述資料如有更改，本署將會另行通知你。請細閱<c:if test="${PDIAppointmentPageValue.testType == '6'}">路試</c:if><c:if test="${PDIAppointmentPageValue.testType == '5'}">筆試</c:if>邀請信夾附的考試須知及攜備有關文件，於考試前15分鐘，到達上述地點向本署職員報到。所有文件將於考試完畢後歸還。</span>
	   </p>
     </td>
   </tr>
   ...
   <tr>
     <td colspan=14  style="vertical-align:top;border:0;padding:0px">
       <p style="text-indent: 2em; text-align: justify;">
	   		<span class="STYLE2">
			<!--如有查詢，請致電運輸署熱線&nbsp;<c:out value="${issuePrintingCtlValue.telNo1}"/><c:if test="${!empty issuePrintingCtlValue.telNo2}">/<c:out value="${issuePrintingCtlValue.telNo2}"/></c:if><c:if test="${!empty issuePrintingCtlValue.telNo3}">/<c:out value="${issuePrintingCtlValue.telNo3}"/></c:if>。-->
   ...
   <tr>
     <td colspan=14  style="vertical-align:top;border:0;padding:0px">
		...
		<tr>
			...
			<td width="50%">
			   <p align="center">
	   			<span class="STYLE2">(<c:out value="${issuePrintingCtlValue.commissorNameChi}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;代行)<sup>2</sup></span>
	   		   </p>
			</td>
		</tr>
		--%>
 ...
 <td  style="text-align:center;border:0">
        ...
        <td style="vertical-align:top;width:20%;border:0;padding:0px">
				...
				<td style="text-align:right;vertical-align:middle;width:30%;border:0;padding:0px">	
						   <p class=MsoNormal style='text-align:justify;text-justify:inter-character;layout-grid-mode:char;line-height:5pt'>
	   						<span lang=EN-US style='font-family:Arial;font-size:1pt;line-height:5pt'>&nbsp;</span></p> 
						<table style="border-spacing:0;width:150px"><tr><td style="border:1px solid;padding:0px"> 	
								<p class=MsoNormal style='text-align:justify;text-justify:inter-character;layout-grid-mode:char;line-height:18pt'>
	   						<span lang=EN-US style='font-family:Arial;font-size:1pt;line-height:5pt'>&nbsp;</span></p>			
						   <p  style="text-align:center">
							<span lang=EN-US style='font-family:Arial;font-size:30pt'>G<c:out value="${pdiGroup}"/></span>
						   </p>
						   <p style="text-align:center;padding-top:7px">
							<span class="STYLE1">(Group <c:out value="${pdiGroup}"/>)</span>
						   </p>
				   	</td></tr></table>
				</td>
				<td style="display: none;" colspan="11"></td>
			...
			<td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
			   <p class=MsoNormal style='text-align:justify;text-justify:inter-character;layout-grid-mode:char;line-height:5pt'>
			   <span lang=EN-US style='font-family:Arial;font-size:1pt;line-height:0pt'>&nbsp;</span></p>
			</td>
		   </tr>
			<tr>
		   ...
		   <span lang=EN-US style='font-family:Arial;font-size:1pt;line-height:5pt'>&nbsp;</span></p>
				...
				<p style='line-height:12pt;text-align:right;padding-right:3px'><span class="STYLE1" >Application No.</span></p>
				</td>
				<td style="text-align:right;vertical-align:middle;width:30%;border:0;padding:0px">
				   <table style="border-spacing:0;width:150px"><tr><td style="text-align:right;border:1px solid;padding:0px">
				   		<p  style="text-align:center"><span class="STYLE8"><b><c:out value="${pdiPrintValue.pdiApplNo}"/></b></span> 
		...
		<tr>
				<td colspan="3" style="width:100%;border:0;padding:0px"><table style="width:100%">
					<tr>
						...
						<td style="border:0;padding:0px"><p style="text-align:justify"><span class="STYLE1"> <!-- in L/M &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    to -->TD DT 47/90/21/<c:if test="${pdiGroup=='1'}">19</c:if><c:if test="${pdiGroup=='2'}">8</c:if><c:if test="${pdiGroup=='3'}">9</c:if><!-- Ⅱ --> (<c:out value="${PDIAppointmentPageValue.txnNo}"/>)</span></p></td>
  ...
  <tr><td colspan="14" style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'><table style="width:100%"><tr style="display:none"><th>Col1</th><th>Col2</th><th>Col3</th><th>Col4</th><th>Col5</th><th>Col6</th><th>Col7</th><th>Col8</th><th>Col9</th><th>Col10</th><th>Col11</th><th>Col12</th><th>Col13</th><th>Col14</th><th>Col15</th></tr><tr><td style="width:20%;border:0;padding:0px"></td>
   ...
   <tr>
    <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
	  <p style="text-align:center">
		<span class="STYLE1"><u><b>Group <c:out value="${pdiGroup}"/> Private Driving Instructor's Test - <c:if test="${PDIAppointmentPageValue.testType == '5'}">Computerized Written</c:if><c:if test="${PDIAppointmentPageValue.testType == '6'}">Road</c:if> Test</b></u></span>
	  </p>
   </td>
  </tr> 
   <tr>
   ...
   <tr>
     <td colspan=14 style='padding-left:0pt; padding-right:0pt; padding-top:0cm; padding-bottom:0cm;vertical-align:top;border:0;padding:0px'>
       <p style="text-indent: 2em; text-align: justify;">
	   		<span class="STYLE1">In relation to your application of the captioned Private Driving Instructor's Test, this Department has arranged the said <c:if test="${PDIAppointmentPageValue.testType == '5'}">written</c:if><c:if test="${PDIAppointmentPageValue.testType == '6'}">road</c:if> test.  Details are as follows:</span>
	   </p>
     </td>
   </tr>
   <tr>
   ...
   <tr>
     <td colspan=14  style="vertical-align:top;border:0;padding:0px">
       <p style="text-indent: 2em; text-align: justify;">
	   		<span class="STYLE1">You will receive further notification if any of the above details are changed.  Please read Notes for Test attached to the invitation letter for <c:if test="${PDIAppointmentPageValue.testType == '5'}">written</c:if><c:if test="${PDIAppointmentPageValue.testType == '6'}">road</c:if> test and bring all relevant documents and report your arrival to the Test Centre 15 minutes before the test.  All documents will be returned to you immediately after the test.</span>
	   </p>
     </td>
   </tr>
