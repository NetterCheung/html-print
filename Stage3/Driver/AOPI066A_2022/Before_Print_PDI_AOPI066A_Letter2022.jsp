    ...
    <tr style="vertical-align:top">
        <td style="text-align:center;border:0">
            <table class="MsoTableGrid cellpadding-0" style='border-collapse: collapse;margin:0 auto;border-spacing:0'>
                ...
                <tr>
                    <td colspan=14 style='padding-left:50pt;border:0;padding:0px'>
                ...
                <tr>
                    <td colspan=14 style="border:0;padding:0px"><p class="STYLE2" style="text-align:center"><u><b>申請第<c:if
                ...
                <tr>
                    <td colspan=14 style="border:0;padding:0px"><p
                            style="text-indent: 2em; text-align: justify; text-justify:inter-character;line-height: 25px;"
                ...
                <tr>
                    <td colspan=14 style="border:0;padding:0px"><p
                            style="text-indent: 2em; text-align: justify;line-height: 25px" class="STYLE2">如有查詢，請致電運輸署熱線&nbsp;<c:out
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                <td style="width:50%;border:0;padding:0px">
                                    <p class="STYLE2" style='line-height: 25px;text-align:justify'>
    ...
    <tr style="vertical-align:bottom">
        <td style="text-align:center;width:100%;border:0">
            <table class="MsoTableGrid cellpadding-0"
                ...
                <tr>
                    <td colspan=14 style="border:0;padding:0px"><p
                            style='text-align: left; text-decoration: underline;text-align:left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                    </td>
                </tr>
                <tr>
                    <td style="border:0;padding:0px"><p class="STYLE7" style="text-align:justify"><sup>1</sup>
                        有關的通訊地址已列於本函的上方，供你核對。</p></td>
                    <td style="display: none;" colspan="13"></td>
                </tr>
                <tr>
                    <td style="border:0;padding:0px"><p class="STYLE7" style="text-align:justify"><sup>2</sup>
                        這是電腦列印的信件，無需簽署。</p></td>
                    <td style="display: none;" colspan="13"></td>
                </tr>
                <tr>
        ...
        <tr style="vertical-align:top">
            <td style="text-align:center;border:0">
                <table class="MsoTableGrid cellpadding-0"
                    ...
                    <tr>
                        <td colspan=14 style="border:0;padding:0px"><p style="line-height: 25px;text-align:justify"
                    ...
                    <tr>
                        <td colspan=14 style="border:0;padding:0px"><p style="line-height: 25px;text-align:center"
        ...
        <tr style="vertical-align:bottom">
            <td style="text-align:center;width:100%;border:0">
                <table class="MsoTableGrid cellpadding-0"
                    ...
                    <tr>
                        <td style="border:0;padding:0px"><p class="STYLE8" style="text-align:justify"><sup>3</sup> The
                            Correspondence Address is printed on the top of this letter for your verification.</p></td>
                        <td style="display: none;" colspan="13"></td>
                    </tr>
                    <tr>
                        <td style="border:0;padding:0px"><p class="STYLE8" style="text-align:justify"><sup>4</sup> This
