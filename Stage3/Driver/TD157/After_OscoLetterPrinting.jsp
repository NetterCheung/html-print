...
<table border="0" cellpadding="0" style="margin:0 auto;border-spacing:0;width:626px">
            ...
            <table style="margin:0 auto;border-spacing:0;width:100%">
                <tr>
                    <td style="padding:0px;border:0">
                        <div style="text-align:justify;-webkit-text-stroke:0.3px;"> 根據司法機構提供的資料，下列針對你／你的車輛的各項依據定額罰款（交通違例事項）條例（第237章）、
    ...
    <tr>
        <td>
            <table style="margin:0 auto;border-spacing:0;width:100%">
                <tr>
                    <td style="padding:0px;border:0;-webkit-text-stroke:0.3px;">法 庭 案 件 編 號</td>
                    <td style="padding:0px;border:0;-webkit-text-stroke:0.3px;">控 票 編 號</td>
                    <td style="padding:0px;border:0;-webkit-text-stroke:0.3px;">罰 款</td>
                    <td style="padding:0px;border:0;-webkit-text-stroke:0.3px;">訴 訟 費</td>
                    <td style="padding:0px;border:0">違 法 日 期</td>
                    <td style="padding:0px;border:0;-webkit-text-stroke:0.3px;">定 罪 日 期</td>
                </tr>
                <tr>
