        ...
        <td style="text-align:center">
            <table style="width:100%;border-spacing:1px">
                ...
                <tr>
                    ...
                    <td colspan="2" style="padding:2px"><c:out value="${pageVal.issuePrintingCtlValue.telNo1}"/></td>
                </tr>
                <tr>
                    <td style="padding:2px">Date:</td>
                    <td colspan="2" style="padding:2px"><fmt:formatDate pattern="dd/MM/yyyy"
                ...
                <tr>
                    ...
                    <td colspan="2" style="padding:2px"><%= nameAndTitleEng%>
                    </td>
                </tr>
                <tr>
                    <td style="padding:2px">&nbsp;</td>
                    <td colspan="2" style="padding:2px"><c:out value="${pageVal.threeLineAddrEng[0]}"
                                                               escapeXml="false"/></td>
                </tr>
                <tr>
                    <td style="padding:2px">&nbsp;</td>
                    <td colspan="2" style="padding:2px"><c:out value="${pageVal.threeLineAddrEng[1]}"
                                                               escapeXml="false"/></td>
                </tr>
                <tr>
                    <td style="padding:2px">&nbsp;</td>
                    <td colspan="2" style="padding:2px"><c:out value="${pageVal.threeLineAddrEng[2]}"
                                                               escapeXml="false"/></td>
                </tr>
            ...
            <td>
                <table style="width:100%;margin:0 auto;border-spacing:1px">
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="padding:2px"><%= nameAndTitleChi%>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:2px">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="padding:2px">
                            ...
                            <div style="text-align:center;">(駕駛執照編號： <c:out
                                    value="${pageVal.legalEntityValue.idNo}"/>)
                            </div>
                            </p>
