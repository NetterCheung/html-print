...
<tr>
	<td>
		...
		<p><img style="border:0" alt="" src="<print:BlankFormPrint imageName='logo.gif'/>" > </p>
		    <p>&nbsp;</p>
			<table     style="width:100%;border-spacing:0px;margin-top:0.7cm;">
              <tr>
			...
			<p style="margin-top:0.3cm;">Dear <codetable:out value="<%=CodeTableConstant.TITLE_CODE%>" formatType="<%=CodeTableConstant.INTERPRETATION%>" language="<%=CodeTableConstant.ENGLISH%>" selected="${legalEntityValue.titleCode}"></codetable:out> <c:out value="${legalEntityValue.nameEng}"/>, </p>
		    <p  style="text-align:center;margin-top:0.4cm;"><span class="ENGLISH_FORMAT1"><u>Eligible Date for Applying for Learner's Driving Licence<br>
		      for
			...
			<p style="margin-top:0.5cm;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="ENGLISH_FORMAT2">According to our record, you are the holder of a full driving licence to drive the following class(es) of motor vehicle –</span></p>
		    <table    style="border-spacing:0px;margin-top:0.45cm;">
        ...
        <c:if test="${!empty acknowMajorConvictions}">
		    ...
		    <p class="ENGLISH_FORMAT2" style="margin-top:0.5cm;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Based on the above record(s), you will be eligible for applying for learner's driving licence for commercial vehicle class(es) from the following date.</p>
		    <table    style="border-spacing:0px;margin-top:0.4cm;">
              <tr style="line-height: 0.8">
		...
		<tr>
			<td style="padding:2px">
			 ...
			 <table style="width:100%;margin:0 auto;border-spacing:1px;">
			    <tr>
			        <td style="padding:2px;">
			        <p class="ENGLISH_FORMAT2" style="text-align:justify;margin-top:-0.2cm;">
			        Note (*): Commercial  Vehicle Class(es) refer to Private Light Bus (code 04), Public Light Bus (code  05), Taxi (code 06), Private Bus (code 09), Public Bus (code 10), Public  Bus-Franchised (code 17), Medium Goods Vehicle (code 18), Heavy Goods Vehicle  (code 19), Articulated Vehicle (code 20) and Special Purpose Vehicle (code 21).
			        </p>
			        </td>
			    </tr>
			 </table>
...
<tr>
	<td>
		...
		<p><img style="border:0" alt="" src="<print:BlankFormPrint imageName='logo.gif'/>" > </p>
			...
			<p class="CHINESE_FORMAT2" style="margin-top:0.4cm;">   <c:choose>
		    ...
		    <p  style="text-align:center;margin-top:0.4cm;"><strong class="CHINESE_FORMAT1"><u>可申請商用車輛類別(*)學習駕駛執照的日期</u></strong><br>
			...
			<p class="CHINESE_FORMAT2" style="margin-top:0.4cm;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;根據本署記錄，你持有下列車輛類別的正式駕駛執照：</p>
		    <table    style="border-spacing:0px">
              <tr style="line-height: 0.8">
		    ...
		    <p class="CHINESE_FORMAT2" style="margin-top:0.6cm;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;就上述記錄，你可於下列日期開始提出有關商用車輛類別學習駕駛執照的申請。</p>
		    <table    style="border-spacing:0px;margin-top:0.4cm;">
              <tr style="line-height: 0.8;">
			...
			<td style="padding:2px">
              ...
              <tr>
                <td   style="width:100%;vertical-align:top;padding:2px">
                	<p  class="CHINESE_FORMAT2" style="text-align:justify;margin-top:0.5cm;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;以上資料是根據本署電腦系統內現時資料提供，並只更新至本函件發出的前一天，因此只可供參考之用。如你的駕駛執照記錄在上述更新期限後有任何改變，包括駕駛執照被取消、駕駛執照過期及觸犯香港法例第374B章《道路交通（駕駛執照）規例》附表12或香港法例第375章《道路交通（違例駕駛記分）條例》內所述的罪行而被定罪，上述相關資料需作出相應更改。</p>
                </td>
			  			</tr>
			  	</table>
		      <p>&nbsp;</p>
			  ...
			  <tr>
                <td   style="width:60%;vertical-align:top;padding:2px"><p  class="CHINESE_FORMAT2" style="text-align:left;margin-top:0.4cm;"><fmt:formatDate value="${lcadPageValue.currentDate}" pattern="yyyy"/> 年
		      ...
		      <p>&nbsp;</p>
		   <table     style="width:560px;border-spacing:0px;margin-top:0.8cm;">
          <tr>
